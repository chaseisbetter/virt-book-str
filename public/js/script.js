console.log('script.js file has been loaded and is being parsed.');

document.addEventListener('DOMContentLoaded', () => {
    console.log('DOMContentLoaded event has fired. Running application logic.');
    ...
    } catch (e) { console.error("Error in Particle Animation:", e); }
    ...
    } catch (e) { console.error("Error in Smooth Scrolling:", e); }
    ...
    } catch (e) { console.error("Error in Signup Form Logic:", e); }
    ...
    } catch (e) { console.error("Error in Login Form Logic:", e); }
    ...
    } catch (e) { console.error("Error in Dynamic Book Loading:", e); }
    ...
    } catch (e) { console.error("Error in Search Autocomplete:", e); }
    ...
    } catch (e) { console.error("Error in Theme Toggle:", e); }
});
